...
def ignore_app_ini(request):
    settings_file = 'mafiademonstration/MafiaDemonstrationApp.ini'
    backup_file = 'mafiademonstration/_MafiaDemonstrationApp.ini'
...
def app(request):
    ...
    Returns:
      :class:`MafiaDemonstrationApp`: App instance
    """
    from kivy.interactive import InteractiveLauncher
    from mafiademonstration.mafiademonstration import MafiaDemonstrationApp
    launcher = InteractiveLauncher(MafiaDemonstrationApp('en'))
